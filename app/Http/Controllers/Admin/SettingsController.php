...
class SettingsController extends MainAdminController
{
    ...
    {  
		...
		$settings->under_maintenane = $inputs['under_maintenane']; 
		
		$settings->site_email = $inputs['site_email'];
		$settings->site_description = $inputs['site_description'];
		$settings->site_keyword = $inputs['site_keyword'];

		$settings->signup_bonus = $inputs['signup_bonus'];
		$settings->referral_cashback = $inputs['referral_cashback'];
		$settings->minimum_withdraw = $inputs['minimum_withdraw'];
		...
		//$settings->google_app_id = $inputs['google_app_id'];
		//$settings->google_secret_key = $inputs['google_secret_key'];
		//$settings->facebook_app_id = $inputs['facebook_app_id'];
		//$settings->facebook_secret_key = $inputs['facebook_secret_key'];
 ...
 public function help(Request $request)
    ...
    {  
		...
		$settings->today_deal = $inputs['today_deal'];
