...
define('EMAIL_ADD', 'aventratechpro@gmail.com'); // define any notification email
define('PAYPAL_EMAIL_ADD', 'aventratechpro@gmail.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
