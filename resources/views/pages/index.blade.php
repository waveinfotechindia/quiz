...
<!-- Slider 1 Area Start Here -->
        <div class="slider1-area slider3-area overlay-default">
            <div class="bend niceties preview-1">
                <div id="ensign-nivoslider-3" class="slides">
                    <img src="{{ URL::asset('site_assets/img/slider/3-1.jpg') }}" alt="slider" title="#slider-direction-1" />
                    <img src="{{ URL::asset('site_assets/img/slider/3-2.jpg') }}" alt="slider" title="#slider-direction-2" />
                    <img src="{{ URL::asset('site_assets/img/slider/3-3.jpg') }}" alt="slider" title="#slider-direction-3" />
                </div>
                    ...
                    <div class="slider-content s-tb slide-1">
                        <div class="title-container s-tb-c">
                            ...
                            <div class="slider-btn-area">
                                <a href="#" class="default-big-btn">Start a Test</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row search-inner">
                        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                            <div class="search-title">
                                <span><i class="fa fa-search" aria-hidden="true"></i> Search Test</span>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                            <div class="search-input">
                                <form>
                                    <input type="text" class="search-form" placeholder="Test Keywords . . ." required="">
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
        ...
        <div class="Tests2-area bg-common-style" style="background-image: url('img/featured/back2.jpg');">
            <div class="container">
                <h2 class="title-default-left">Featured Tests</h2>
            </div>
            <div class="container Tests-list-wrapper">
                <div class="row Tests-wrapper Tests-list">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 Tests-item">
                        <div class="Tests-box2">
                        ...
                        <ul class="news-wrapper">
                            <li>
                                <div class="news-img-holder">
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/news/1.jpg" class="img-responsive') }}" alt="news"></a>
                                </div>
                            ...
                            <li>
                                <div class="news-img-holder">
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/news/2.jpg" class="img-responsive') }}" alt="news"></a>
                                </div>
                                <div class="news-content-holder">
                            ...
                            <li>
                                <div class="news-img-holder">
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/news/3.jpg" class="img-responsive') }}" alt="news"></a>
                                </div>
                                <div class="news-content-holder">
                    ...
                    <div class="students-join3-left">
                        <div id="ri-grid" class="author-banner-bg ri-grid header text-center">
                            <ul class="ri-grid-list">
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student1.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student2.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student3.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student4.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student5.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student6.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student7.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student8.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ URL::asset('site_assets/img/students/student1.jpg') }}" alt=""></a>
                                </li>
            ...
            <div class="container">
                <div class="rc-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-r-x-small="2" data-r-x-small-nav="false" data-r-x-small-dots="false" data-r-x-medium="3" data-r-x-medium-nav="false" data-r-x-medium-dots="false" data-r-small="4" data-r-small-nav="false" data-r-small-dots="false" data-r-medium="4" data-r-medium-nav="false" data-r-medium-dots="false" data-r-large="4" data-r-large-nav="false" data-r-large-dots="false">
                    <div class="brand-area-box">
                        <a href="#"><img src="{{ URL::asset('site_assets/img/brand/1.jpg') }}" alt="brand"></a>
                    </div>
                    <div class="brand-area-box">
                        <a href="#"><img src="{{ URL::asset('site_assets/img/brand/2.jpg') }}" alt="brand"></a>
                    </div>
                    <div class="brand-area-box">
                        <a href="#"><img src="{{ URL::asset('site_assets/img/brand/3.jpg') }}" alt="brand"></a>
                    </div>
                    <div class="brand-area-box">
                        <a href="#"><img src="{{ URL::asset('site_assets/img/brand/4.jpg') }}" alt="brand"></a>
                    </div>
                    <div class="brand-area-box">
                        <a href="#"><img src="{{ URL::asset('site_assets/img/brand/1.jpg') }}" alt="brand"></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                <a href="index.html"><img class="img-responsive" src="{{ URL::asset('site_assets/img/logo-footer.png') }}" alt="logo"></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                ...
                                <ul class="flickr-photos">
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/1.jpg') }}" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/2.jpg') }}" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/3.jpg') }}" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/4.jpg') }}" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/5.jpg') }}" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="{{ URL::asset('site_assets/img/footer/6.jpg') }}" alt="flickr"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
