                                ...
                                {!! Form::open(array('url' => array('admin/subcategories/addsubcategory'),'class'=>'form-horizontal padding-15','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                                        ...
                                        <div class="col-sm-9">
                                            <select id="basic" name="category" class="js-select2 form-control">
                                                ...
                                                @foreach($categories as $i => $category)    
                                                    <option value="{{$category->cat_id}}" <?php if(isset($subcat->cat_parent) && $subcat->cat_parent==$category->cat_id)echo 'selected';?>>{{$category->category_name}}</option> 
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sub Category Name</label>
                                          <div class="col-sm-9">
                                            <input type="text" name="category_name" value="{{ isset($subcat->category_name) ? $subcat->category_name : null }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="category_slug" value="{{ isset($subcat->category_slug) ? $subcat->category_slug : null }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <div class="form-group">
                                        <label for="first" class="col-md-3 control-label">Feature-Image :-</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <img src="{{ URL::asset('site_assets/banner/'.$subcat->image) }}" width="80" alt="featured">
                                        @endif
                                    </div>
                                     </div>
                                    <div class="form-group">
