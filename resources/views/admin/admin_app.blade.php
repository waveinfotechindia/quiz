...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCfwi4oFczmmB9X5YqEfFsyHD98GP6pC8s&libraries=places"></script>
   <script type="text/javascript">
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            ...
            var places = new google.maps.places.Autocomplete(document.getElementById('product'),options);
